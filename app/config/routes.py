...
routes['POST']['/submit'] = 'Welcome#submit'
routes['/success'] = 'Welcome#success'
routes['/logout'] = 'Welcome#logout'
routes['POST']['/login'] = 'Welcome#login'
routes['/meals/<id>'] = 'Welcome#meals'
routes['/weight/<id>'] = 'Welcome#weight'
routes['/menu/<id>'] = 'Welcome#menu'
routes['POST']['/update_weight/<id>'] = 'Welcome#update_weight'
routes['POST']['/add_meal/<id>'] = 'Welcome#add_meal'
